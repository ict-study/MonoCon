...
class MonoConHeadNorm(nn.Module):
    def __init__(self,
                 in_channel,
                 feat_channel,
                 num_classes,
                 ...
                 test_cfg=None,
                 init_cfg=None):
        super(MonoConHeadNorm, self).__init__()
    ...
    def loss(self,
        ...
        ## this will be modified, using the multibins directly pred the alpha
        ## existing some bugs in monocon
        # alpha cls
