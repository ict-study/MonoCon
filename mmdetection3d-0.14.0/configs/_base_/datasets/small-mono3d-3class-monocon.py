...
data_root = '/mnt/vepfs/Perception/perception-public/QcraftDataset/Mono3d_20230119/'
...
train_pipeline = [
    ...
    #dict(type="Mono3dVisTools",stage="flip", debug_mode=True, after_bundle=False, save_prefix='/root/code/vis/shift'),
